...
//========================================
session_start();
$jsonlanguage = $_SESSION['jsonlanguage'];
if ($jsonlanguage == '') {$jsonlanguage = file_get_contents('https://raw.githubusercontent.com/MinterCat/Language/master/MinterCat_English.json');}
