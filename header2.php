      ...
      <div class='container'>
        <div class='top-header__inner'>
          ...
          <a href='#' class='logo top-header__logo'>
            <!-- <img src='https://mintercat.com/img/svg/logo.svg' alt='MinterCat' class='logo__img'> -->
            <!-- <svg class='logo__img'>
...
echo "<ul class='social nav-top__social'>
      ...
      <div class='container'>
        <div class='profile-section__inner'>
		  ...
		  <div style='position: left'>
            ...
            <div class='profile-info__item'>
              <div class='profile-info__item-title'>" . $language['My_wallet'] . "</div>
              <div class='profile-info__item-body'>
