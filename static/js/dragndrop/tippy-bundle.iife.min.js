var tippy = function(t) {
  ...
  function rt(r, i) {
    ...
    var k, M, S, P, V, B = !1,
      ...
      st = {
        ...
        hide: function(t) {
          ...
          At(), rt.style.visibility = "hidden", st.state.isVisible = !1, st.state.isShown = !1, m(ut, t), g(ut, "hidden"), ht(), bt(),
            function(t, e) {
              Tt(t, (function() {
    ...
    function St() {
      var n, i = st.props.popperOptions,
                ...
                switch (t) {
                  ...
                  case "bottom":
                    var r = n[0],
                      ...
                      s = o ? r.right : i.right;
                    return {
                      top: a, bottom: p, left: u, right: s, width: s - u, height: p - a
                    };
                  case "left":
                  case "right":
                    ...
                    return {
                      top: d, bottom: v, left: c, right: l, width: l - c, height: v - d
                    };
                  default:
                    return e
                }
